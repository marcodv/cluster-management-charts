...
```
cd existing_repo
git remote add origin https://gitlab.com/noah-energy/k8s-noah.git
git branch -M main
...
- [ ] [Set up project integrations](https://gitlab.com/-/experiment/new_project_readme_content:368b2e8c408559d13fefa2cdc138bc3d?https://gitlab.com/noah-energy/k8s-noah/-/settings/integrations)
